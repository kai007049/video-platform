...
import com.kai.videoplatform.mapper.MessageMapper;
...
public class MessageServiceImpl implements MessageService {
    ...
    private final com.kai.videoplatform.mapper.UserMapper userMapper;
    ...
    public java.util.List<MessageConversationVO> listConversations(Long userId) {
        ...
        return latestMap.entrySet().stream().map(e -> {
            ...
            com.kai.videoplatform.entity.User target = userMap.get(e.getKey());
            if (target != null) {
